namespace Alchemy
{
    ...
    public class CVfxLitLiquidMaterial : igFxMaterial
    {
        ...
        public class VfxMaterialBitfield : igBitFieldMetaField
        {
            ...
            [FieldAttr(offset: 3, size: 1)] public bool _textureCompression_diffuse;
            [FieldAttr(offset: 4, size: 1)] public bool _textureMips_diffuse;
            [FieldAttr(offset: 5, size: 1)] public bool _textureAllowDownsample_diffuse;
            [FieldAttr(offset: 6, size: 1)] public bool _textureCompression_mask;
            [FieldAttr(offset: 7, size: 1)] public bool _textureMips_mask;
            [FieldAttr(offset: 8, size: 1)] public bool _textureAllowDownsample_mask;
            [FieldAttr(offset: 9, size: 1)] public bool _textureCompression_normal;
            [FieldAttr(offset: 10, size: 1)] public bool _textureMips_normal;
            [FieldAttr(offset: 11, size: 1)] public bool _textureAllowDownsample_normal;
        }
