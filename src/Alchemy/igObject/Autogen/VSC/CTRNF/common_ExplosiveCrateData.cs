namespace Alchemy
{
    [ObjectAttr(ctr: 240, align: 4, metaType: typeof(CVscComponentData))]
    public class common_ExplosiveCrateData : CVscComponentData
    {
        ...
        [FieldAttr(ctr: 144)] public int _Int;
        [FieldAttr(ctr: 152)] public igHandleMetaField _Vfx_Effect_0x98 = new();
        [FieldAttr(ctr: 160)] public igHandleMetaField _Bolt_Point = new();
        ...
        [FieldAttr(ctr: 232)] public igHandleMetaField _Rumble_Data = new();
    }
}
