namespace Alchemy
{
    ...
    public class common_WarpOrbData : CVscComponentData
    {
        [FieldAttr(ctr: 32)] public int _Int;
        [FieldAttr(ctr: 40)] public igHandleMetaField _Component_Data_0x28 = new();
        [FieldAttr(ctr: 48)] public igHandleMetaField _Component_Data_0x30 = new();
        [FieldAttr(ctr: 56)] public igHandleMetaField _Sound_0x38 = new();
        [FieldAttr(ctr: 64)] public igHandleMetaField _Sound_0x40 = new();
        [FieldAttr(ctr: 72)] public igHandleMetaField _common_BombDatas008 = new();
