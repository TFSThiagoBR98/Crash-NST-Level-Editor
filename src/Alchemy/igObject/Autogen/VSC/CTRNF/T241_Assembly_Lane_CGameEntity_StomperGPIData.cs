namespace Alchemy
{
    [ObjectAttr(ctr: 136, align: 4, metaType: typeof(CVscComponentData))]
    public class T241_Assembly_Lane_CGameEntity_StomperGPIData : CVscComponentData
    {
        ...
        [FieldAttr(ctr: 128)] public igHandleMetaField _Rumble_Data = new();
    }
}
