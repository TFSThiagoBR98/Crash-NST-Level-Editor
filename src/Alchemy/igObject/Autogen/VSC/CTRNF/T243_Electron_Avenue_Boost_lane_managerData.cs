namespace Alchemy
{
    ...
    public class T243_Electron_Avenue_Boost_lane_managerData : CVscComponentData
    {
        [FieldAttr(ctr: 32)] public igHandleMetaField _Kart_Boost_Data = new();
        [FieldAttr(ctr: 40)] public igHandleMetaField _Sound = new();
        [FieldAttr(ctr: 48)] public igHandleMetaField _Sound_id_hkc6b4cy001 = new();
        [FieldAttr(ctr: 56)] public igHandleMetaField _Entity_List_0x38 = new();
        [FieldAttr(ctr: 64)] public igHandleMetaField _Entity_List_0x40 = new();
