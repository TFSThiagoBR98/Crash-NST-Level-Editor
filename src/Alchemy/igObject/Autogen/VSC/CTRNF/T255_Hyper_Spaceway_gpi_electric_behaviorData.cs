namespace Alchemy
{
    ...
    public class T255_Hyper_Spaceway_gpi_electric_behaviorData : CVscComponentData
    {
        ...
        [FieldAttr(ctr: 80)] public bool _Bool;
        ...
        [FieldAttr(ctr: 136)] public igHandleMetaField _Rumble_Data = new();
