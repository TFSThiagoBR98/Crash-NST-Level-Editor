namespace Alchemy
{
    ...
    public class T121_Slide_Coliseum_POD_D_Dance_Manager_BehaviorData : CVscComponentData
    {
        ...
        [FieldAttr(ctr: 64)] public igHandleMetaField _Vfx_Effect_id_7he57se0001 = new();
