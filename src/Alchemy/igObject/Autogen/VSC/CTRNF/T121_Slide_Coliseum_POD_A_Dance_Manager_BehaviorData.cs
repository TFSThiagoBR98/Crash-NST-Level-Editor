namespace Alchemy
{
    ...
    public class T121_Slide_Coliseum_POD_A_Dance_Manager_BehaviorData : CVscComponentData
    {
        ...
        [FieldAttr(ctr: 64)] public igHandleMetaField _Vfx_Effect_id_m2yq47b9001 = new();
        [FieldAttr(ctr: 72)] public igHandleMetaField _Bolt_Point_id_6giscbvc001 = new();
        [FieldAttr(ctr: 80)] public igHandleMetaField _Vfx_Effect_id_tdq5vset001 = new();
    }
}
